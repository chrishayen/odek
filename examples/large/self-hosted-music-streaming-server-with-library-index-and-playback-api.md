...
std
  ...
  std.audio
    std.audio.read_tags
      @ (path: string) -> result[audio_tags, string]
...
music_server
  music_server.new
    @ (library_root: string) -> server_state
  ...
  music_server.search_tracks
    @ (state: server_state, query: string) -> list[track]
