...
admin_panel
  ...
  admin_panel.add_user
    fn (state: panel_state, username: string, password: string) -> result[panel_state, string]
  ...
  admin_panel.authenticate
    fn (state: panel_state, username: string, password: string) -> result[string, string]
  ...
  admin_panel.check_session
    fn (state: panel_state, token: string) -> result[string, string]
  ...
  admin_panel.revoke_session
    fn (state: panel_state, token: string) -> panel_state
