...
fortran_transpile
  ...
  fortran_transpile.parse
    fn (tokens: list[token]) -> result[program_ast, string]
  ...
  fortran_transpile.resolve_symbols
    fn (ast: program_ast) -> result[program_ast, string]
  ...
  fortran_transpile.lower_arrays
    fn (ast: program_ast) -> program_ast
  ...
  fortran_transpile.collect_diagnostics
    fn (ast: program_ast) -> list[diagnostic]
