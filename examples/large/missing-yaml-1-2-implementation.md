...
yaml
  yaml.scan
    @ (source: string) -> result[list[yaml_token], string]
    ...
    -> std.text.is_whitespace
  yaml.parse_events
    @ (tokens: list[yaml_token]) -> result[list[yaml_event], string]
