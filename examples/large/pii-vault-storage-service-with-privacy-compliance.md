...
pii_vault
  pii_vault.open
    @ (master_key: bytes) -> result[vault_state, string]
  ...
  pii_vault.store_record
    @ (state: vault_state, subject_id: string, fields: map[string,string], consent_tags: list[string]) -> result[string, string]
