...
std
  ...
  std.sql
    std.sql.tokenize
      fn (source: string) -> list[sql_token]
...
dbmgr
  ...
  dbmgr.register_connection
    fn (m: manager_state, id: string, conn_string: string) -> result[void, string]
  ...
  dbmgr.execute
    ...
    -> std.sql.tokenize
  dbmgr.explain
    fn (m: manager_state, id: string, sql: string) -> result[string, string]
