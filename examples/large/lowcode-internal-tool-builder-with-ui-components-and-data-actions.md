...
toolbuilder
  ...
  toolbuilder.add_component
    fn (app: app_state, kind: string, props: map[string, string]) -> tuple[string, app_state]
  ...
  toolbuilder.add_data_source
    fn (app: app_state, name: string, endpoint: string) -> app_state
    + registers a named data source pointing at an endpoint
    # data_binding
  toolbuilder.add_query
    fn (app: app_state, name: string, source: string, template: string) -> result[app_state, string]
  ...
  toolbuilder.bind_component
    fn (app: app_state, component_id: string, prop: string, query_name: string) -> result[app_state, string]
  ...
  toolbuilder.add_action
    fn (app: app_state, name: string, target_query: string) -> result[app_state, string]
  ...
  toolbuilder.attach_event
    fn (app: app_state, component_id: string, event: string, action: string) -> result[app_state, string]
  ...
  toolbuilder.resolve_component
    fn (app: app_state, component_id: string) -> result[resolved_component, string]
  ...
  toolbuilder.dispatch_event
    fn (app: app_state, component_id: string, event: string) -> result[list[string], string]
  ...
  toolbuilder.import_app
    fn (raw: string) -> result[app_state, string]
