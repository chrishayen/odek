...
appserver
  appserver.new_pool
    @ (min_workers: i32, max_workers: i32) -> pool_state
    + creates a pool with size bounds and no workers yet
    # construction
  appserver.spawn_worker
    @ (state: pool_state, command: string) -> tuple[string, pool_state]
