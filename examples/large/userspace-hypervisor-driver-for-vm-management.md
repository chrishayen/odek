...
vmm
  vmm.create
    @ (name: string) -> result[vm_handle, string]
  ...
  vmm.destroy
    ...
    -> std.syscall.close_fd
  vmm.set_memory
    @ (vm: vm_handle, bytes_count: u64) -> result[vm_handle, string]
    ...
    -> std.syscall.mmap
  vmm.load_image
    @ (vm: vm_handle, guest_phys: u64, image: bytes) -> result[void, string]
