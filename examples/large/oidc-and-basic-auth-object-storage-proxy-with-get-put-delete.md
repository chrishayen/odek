...
obj_proxy
  obj_proxy.new
    fn (bucket: string, basic_users: map[string,string], oidc_issuer: string, oidc_jwks: bytes) -> obj_proxy_state
  ...
  obj_proxy.authenticate_basic
    fn (state: obj_proxy_state, header: string) -> result[string, string]
  ...
  obj_proxy.handle_get
    fn (state: obj_proxy_state, key: string, auth_header: string) -> bytes
  ...
  obj_proxy.handle_put
    fn (state: obj_proxy_state, key: string, body: bytes, auth_header: string) -> bytes
  ...
  obj_proxy.handle_delete
    ...
    -> std.http.encode_response
  obj_proxy.dispatch
    fn (state: obj_proxy_state, raw_request: bytes) -> bytes
