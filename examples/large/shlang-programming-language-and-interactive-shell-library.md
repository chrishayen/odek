...
shlang
  ...
  shlang.parse_expression
    fn (tokens: list[token]) -> result[expr, string]
  ...
  shlang.bind
    ...
    # state
  shlang.lookup
    fn (env: env_state, name: string) -> optional[value]
