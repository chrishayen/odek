...
std
  ...
  std.math
    std.math.vec3_normalize
      @ (v: tuple[f64, f64, f64]) -> tuple[f64, f64, f64]
      + returns v scaled to unit length
      ? returns (0,0,0) when v has zero length
      # math
    std.math.vec3_dot
      @ (a: tuple[f64, f64, f64], b: tuple[f64, f64, f64]) -> f64
      + returns the dot product
      # math
    std.math.vec3_cross
      @ (a: tuple[f64, f64, f64], b: tuple[f64, f64, f64]) -> tuple[f64, f64, f64]
      + returns the cross product
      # math

pbr_rt
  pbr_rt.load_gltf
    @ (path: string) -> result[scene_state, string]
