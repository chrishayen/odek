...
pdf
  pdf.parse
    fn (raw: bytes) -> result[pdf_doc, string]
    ...
    -> std.compression.zlib_inflate
  pdf.load
    fn (path: string) -> result[pdf_doc, string]
