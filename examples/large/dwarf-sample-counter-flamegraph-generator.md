...
flamegraph
  flamegraph.load_dwarf
    fn (data: bytes) -> result[symbol_table, string]
  ...
  flamegraph.resolve_address
    fn (st: symbol_table, pc: u64) -> optional[string]
  ...
  flamegraph.resolve_stack
    fn (st: symbol_table, stack: list[u64]) -> list[string]
