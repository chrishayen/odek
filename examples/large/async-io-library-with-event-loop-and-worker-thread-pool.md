...
event_loop
  ...
  event_loop.add_timer
    fn (loop: loop_state, delay_ms: i64, tag: string) -> u64
  ...
  event_loop.worker_start
    fn (loop: loop_state, count: i32) -> void
