...
std
  ...
  std.graph
    std.graph.topological_sort
      @ (nodes: list[string], edges: list[tuple[string, string]]) -> result[list[string], string]
...
assets
  assets.new_registry
    ...
    # construction
  assets.define_asset
    @ (reg: registry_state, name: string, deps: list[string], compute: function[map[string, bytes], bytes]) -> result[registry_state, string]
    ...
    # registration
  assets.plan_run
    @ (reg: registry_state, targets: list[string]) -> result[list[string], string]
    ...
    -> std.graph.topological_sort
  assets.materialize
    @ (reg: registry_state, plan: list[string]) -> result[run_record, string]
