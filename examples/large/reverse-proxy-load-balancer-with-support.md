...
balancer
  ...
  balancer.release
    ...
    # selection
  balancer.forward
    @ (state: balancer_state, raw: bytes) -> result[tuple[bytes, balancer_state], string]
