...
hex_strategy
  hex_strategy.new_game
    fn (width: i32, height: i32, player_count: i32) -> game_state
    + creates a fresh game with empty tiles and the given player count
    ? uses axial coordinates internally
    # construction
  hex_strategy.place_unit
    fn (state: game_state, player: i32, kind: string, q: i32, r: i32) -> result[game_state, string]
  ...
  hex_strategy.move_unit
    ...
    # movement
  hex_strategy.attack
    fn (state: game_state, attacker_id: i32, defender_id: i32) -> result[game_state, string]
