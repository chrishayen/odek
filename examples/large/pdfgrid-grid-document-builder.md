...
std
  std.pdf
    std.pdf.new_document
      fn (page_size: string) -> pdf_doc
      + creates an empty PDF document with the given page size
      # pdf
    std.pdf.draw_text
      fn (doc: pdf_doc, x: f64, y: f64, text: string, font: string, size: f64) -> pdf_doc
      + draws text at the given point
      # pdf
    std.pdf.draw_image
      fn (doc: pdf_doc, x: f64, y: f64, w: f64, h: f64, image: bytes) -> result[pdf_doc, string]
      + draws an embedded image at the given rectangle
      - returns error on unsupported image formats
      # pdf
    std.pdf.draw_line
      fn (doc: pdf_doc, x1: f64, y1: f64, x2: f64, y2: f64) -> pdf_doc
      + draws a stroked line
      # pdf
    std.pdf.new_page
      fn (doc: pdf_doc) -> pdf_doc
      + starts a new page
      # pdf
    std.pdf.to_bytes
