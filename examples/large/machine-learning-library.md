...
std
  ...
  std.random
    std.random.shuffle_indices
      @ (n: i32, seed: i64) -> list[i32]
      + returns a deterministic shuffled permutation of [0, n)
      # randomness
  std.linalg
    std.linalg.matvec
      @ (m: list[list[f64]], v: list[f64]) -> list[f64]
