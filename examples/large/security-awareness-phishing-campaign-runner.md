...
std
  ...
  std.net
    std.net.smtp_send
      fn (host: string, port: u16, from: string, to: string, message: string) -> result[void, string]
...
awareness
  ...
  awareness.record_interaction
    fn (state: campaign_state, token: string, kind: string) -> result[campaign_state, string]
