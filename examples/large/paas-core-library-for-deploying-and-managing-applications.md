...
paas
  paas.new_platform
    ...
    # construction
  paas.create_app
    fn (state: platform_state, name: string) -> result[tuple[string, platform_state], string]
    ...
    -> std.time.now_seconds
  paas.push_version
    fn (state: platform_state, app_id: string, source: bytes) -> result[tuple[string, platform_state], string]
    ...
    -> std.time.now_seconds
  paas.deploy
    fn (state: platform_state, app_id: string, version_id: string) -> result[platform_state, string]
