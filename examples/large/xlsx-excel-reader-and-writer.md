...
xlsx
  ...
  xlsx.set_cell_number
    fn (book: book_state, sheet: string, row: i32, col: i32, value: f64) -> result[book_state, string]
    + returns the book with the numeric cell set
    - returns error when the sheet does not exist
    # mutation
  xlsx.set_cell_string
    fn (book: book_state, sheet: string, row: i32, col: i32, value: string) -> result[book_state, string]
    + returns the book with the string cell set
    - returns error when the sheet does not exist
    # mutation
  xlsx.set_cell_formula
    fn (book: book_state, sheet: string, row: i32, col: i32, formula: string) -> result[book_state, string]
  ...
  xlsx.evaluate_formulas
    fn (book: book_state) -> result[book_state, string]
