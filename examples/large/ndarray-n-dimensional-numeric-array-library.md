...
ndarray
  ndarray.from_values
    fn (shape: list[i32], values: list[f64]) -> result[array, string]
  ...
  ndarray.matmul
    ...
    # linear_algebra
  ndarray.transpose
    fn (a: array) -> result[array, string]
