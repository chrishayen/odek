...
std
  std.net
    ...
    std.net.tcp_read_line
      fn (conn: conn_handle) -> result[string, string]
...
email_service
  email_service.parse_address
    fn (raw: string) -> result[email_address, string]
  ...
  email_service.smtp_connect
    fn (host: string, port: i32) -> result[smtp_session, string]
  ...
  email_service.smtp_send
    fn (s: smtp_session, m: message_state) -> result[void, string]
