...
std
  std.http
    ...
    std.http.put
      ...
      # http
    std.http.delete
      fn (url: string, headers: map[string, string]) -> result[void, string]
...
doc_client
  doc_client.register_driver
    fn (name: string, driver_id: string) -> void
    + registers a driver under a name
    # driver_registration
  doc_client.new
    fn (driver_name: string, endpoint: string) -> result[client_state, string]
  ...
  doc_client.create_database
    fn (state: client_state, name: string) -> result[void, string]
    + creates a database
  ...
  doc_client.put_document
    fn (state: client_state, database: string, id: string, doc: map[string, string]) -> result[string, string]
  ...
  doc_client.get_document
    fn (state: client_state, database: string, id: string) -> result[map[string, string], string]
  ...
  doc_client.delete_document
    fn (state: client_state, database: string, id: string, revision: string) -> result[void, string]
    + deletes a document at the given revision
    - returns error on revision conflict
    # documents
    -> std.http.delete
  doc_client.query_view
    fn (state: client_state, database: string, design: string, view: string, key: string) -> result[list[map[string, string]], string]
    ...
    -> std.json.parse_object
  doc_client.all_docs
    fn (state: client_state, database: string) -> result[list[string], string]
    + returns every document id in the database
    # query
    -> std.http.get
    -> std.json.parse_object
  doc_client.changes
    fn (state: client_state, database: string, since: string) -> result[list[map[string, string]], string]
