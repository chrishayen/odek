...
phonenum
  phonenum.normalize
    ...
    -> std.unicode.digit_value
  phonenum.parse
    fn (raw: string, default_region: string) -> result[phone_number, string]
  ...
  phonenum.store_deserialize
    fn (stored: string) -> result[phone_number, string]
