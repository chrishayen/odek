...
runtime
  runtime.new
    @ (node_id: string) -> runtime_state
    + creates a runtime with an empty service table and registry
    # construction
  runtime.register_service
    @ (state: runtime_state, name: string, version: string) -> runtime_state
  ...
  runtime.call
    ...
    -> std.encoding.decode_message
  runtime.serve_once
    @ (state: runtime_state, conn: conn_state, handler: string) -> result[void, string]
