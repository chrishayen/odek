...
embed
  embed.fetch_info
    fn (url: string) -> result[embed_info, string]
  ...
  embed.discover_oembed_endpoint
    fn (doc: html_doc) -> optional[string]
  ...
  embed.extract_generic_meta
    ...
    -> std.html.find_meta_tags
  embed.fetch_oembed
    fn (endpoint: string) -> result[map[string, string], string]
