...
std
  ...
  std.collections
    ...
    std.collections.hashmap_get
      fn (m: map[string, value], key: string) -> optional[value]
...
interpreter
  ...
  interpreter.eval_statement
    fn (node: ast_node, env: environment) -> result[environment, string]
  ...
  interpreter.call_function
    fn (func: value, args: list[value], env: environment) -> result[value, string]
