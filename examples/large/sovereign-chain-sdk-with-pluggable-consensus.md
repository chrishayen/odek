...
chain
  ...
  chain.apply_transaction
    fn (state: chain_state, signed: signed_transaction) -> result[chain_state, string]
  ...
  chain.new_network
    ...
    # networking
  chain.add_peer
    fn (net: network_state, peer_id: string, address: string) -> network_state
    + returns a network with the peer registered
    # networking
  chain.gossip_block
    fn (net: network_state, block: block) -> list[string]
    + returns the peer ids the block was forwarded to
    # networking
  chain.gossip_transaction
    fn (net: network_state, tx: signed_transaction) -> list[string]
