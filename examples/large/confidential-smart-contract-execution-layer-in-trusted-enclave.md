...
confidential_contract
  ...
  confidential_contract.attest_transition
    fn (state: runtime_state, prev_root: bytes, new_root: bytes) -> bytes
  ...
  confidential_contract.verify_attestation
    fn (prev_root: bytes, new_root: bytes, quote: bytes, expected_measurement: bytes) -> bool
