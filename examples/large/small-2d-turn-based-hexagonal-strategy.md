...
hexwar
  ...
  hexwar.reachable_tiles
    @ (state: board_state, unit_id: string) -> result[list[hex_coord], string]
    ...
    -> hexwar.neighbors
  hexwar.move_unit
    @ (state: board_state, unit_id: string, to: hex_coord) -> result[board_state, string]
    ...
    # movement
  hexwar.attack
    @ (state: board_state, attacker_id: string, defender_id: string) -> result[battle_outcome, string]
