...
image_sign
  ...
  image_sign.fetch_signatures
    fn (registry: registry_handle, digest: string) -> result[list[signature_record], string]
  ...
  image_sign.verify_signature
    fn (record: signature_record, public_key: bytes, expected_digest: string) -> result[void, string]
  ...
  image_sign.verify_image
    fn (registry: registry_handle, manifest: bytes, public_keys: list[bytes]) -> result[signature_record, string]
