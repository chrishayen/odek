...
codegen
  ...
  codegen.parse_directives
    @ (tokens: list[token]) -> result[list[directive], string]
  ...
  codegen.define_macro
    @ (state: codegen_state, name: string, params: list[string], body: string) -> codegen_state
    + registers a macro definition
    # macros
  codegen.expand_macro
    @ (state: codegen_state, name: string, args: list[string]) -> result[string, string]
  ...
  codegen.instantiate_generic
    @ (state: codegen_state, template_name: string, type_args: list[string]) -> result[string, string]
  ...
  codegen.set_condition
    @ (state: codegen_state, flag: string, value: bool) -> codegen_state
    + sets a named flag used by conditional compilation
    # conditionals
  codegen.eval_condition
    @ (state: codegen_state, expr: string) -> result[bool, string]
