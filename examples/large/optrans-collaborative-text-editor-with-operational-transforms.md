...
optrans
  ...
  optrans.op_delete
    ...
    # op_construction
  optrans.apply
    @ (doc: document_state, ops: list[op]) -> result[document_state, string]
    ...
    # editing
  optrans.transform
    @ (a: list[op], b: list[op]) -> result[tuple[list[op], list[op]], string]
    ...
    # transformation
  optrans.compose
    @ (first: list[op], second: list[op]) -> result[list[op], string]
