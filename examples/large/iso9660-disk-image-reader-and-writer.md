...
std
  ...
  std.bytes
    std.bytes.read_u16_le
      fn (data: bytes, offset: i64) -> result[u16, string]
...
iso9660
  iso9660.read_image
    fn (path: string) -> result[iso_image, string]
  ...
  iso9660.parse_volume_descriptor
    fn (sector: bytes) -> result[iso_volume_descriptor, string]
  ...
  iso9660.parse_path_table
    fn (data: bytes) -> result[list[iso_path_entry], string]
  ...
  iso9660.parse_directory_record
    fn (data: bytes, offset: i64) -> result[iso_dir_record, string]
  ...
  iso9660.build_image
    ...
    -> std.bytes.write_u32_le
  iso9660.write_image
    fn (builder: iso_builder, path: string) -> result[void, string]
