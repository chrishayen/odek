...
load_test
  ...
  load_test.worker_loop
    fn (state: run_state, deadline_ns: i64) -> void
  ...
  load_test.format_tui_frame
    fn (snapshot: metrics_snapshot, width: i32, height: i32) -> string
    + renders a text frame with headline numbers and a small ASCII latency histogram
    # rendering
  load_test.live_frames
    fn (state: run_state, interval_ms: i32, emit: fn(string) -> void) -> void
