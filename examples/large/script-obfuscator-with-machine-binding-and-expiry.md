...
script_protect
  ...
  script_protect.decrypt_payload
    @ (payload: encrypted_payload, key: bytes) -> result[string, string]
  ...
  script_protect.build_artifact
    @ (source: string, password: string, bound_fingerprint: optional[string], expires_at: optional[i64]) -> result[string, string]
  ...
  script_protect.parse_artifact
    @ (artifact: string) -> result[artifact_header, string]
  ...
  script_protect.check_binding
    @ (header: artifact_header) -> result[void, string]
  ...
  script_protect.load_artifact
    @ (artifact: string, password: string) -> result[string, string]
  ...
  script_protect.write_artifact
    @ (source_path: string, output_path: string, password: string, bind: bool, ttl_seconds: optional[i64]) -> result[void, string]
