...
std
  std.net
    ...
    std.net.accept_nonblocking
      @ (listener: listener_handle) -> result[optional[conn_handle], string]
...
event_loop_server
  ...
  event_loop_server.set_on_open
    @ (set: handler_set, handler_id: string) -> handler_set
  ...
  event_loop_server.dispatch_events
    @ (worker: worker_state, handlers: handler_set, invoker: handler_invoker) -> result[worker_state, string]
  ...
  event_loop_server.accept_pending
    @ (state: server_state) -> result[server_state, string]
