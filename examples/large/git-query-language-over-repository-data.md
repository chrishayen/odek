...
git_query
  git_query.open_repo
    fn (path: string) -> result[repo_state, string]
  ...
  git_query.load_commit
    fn (r: repo_state, oid: string) -> result[commit_record, string]
  ...
  git_query.walk_commits
    fn (r: repo_state, start_ref: string, limit: i32) -> result[list[commit_record], string]
  ...
  git_query.parse_select
    fn (tokens: list[token]) -> result[select_ast, string]
  ...
  git_query.bind_table
    fn (r: repo_state, ast: select_ast) -> result[row_source, string]
  ...
  git_query.evaluate_where
    fn (src: row_source, ast: select_ast) -> result[row_source, string]
