...
markup
  markup.tokenize
    fn (source: string) -> result[list[markup_token], string]
    ...
    # lexing
  markup.parse_html
    fn (source: string) -> result[element, string]
