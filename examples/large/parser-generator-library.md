...
parsergen
  parsergen.new_grammar
    fn (start_symbol: string) -> grammar_state
  ...
  parsergen.add_rule
    ...
    # grammar
  parsergen.compile
    fn (grammar: grammar_state) -> result[parser, string]
