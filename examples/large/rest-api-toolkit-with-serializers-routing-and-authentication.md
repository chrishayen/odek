...
webapi
  webapi.new_router
    ...
    # construction
  webapi.add_route
    @ (r: router_state, method: string, pattern: string, handler_id: string) -> router_state
  ...
  webapi.serialize_resource
    @ (fields: map[string, json_value], visible: list[string]) -> string
  ...
  webapi.verify_token
    ...
    -> std.crypto.hmac_sha256
  webapi.require_auth
    @ (req: http_request, secret: bytes) -> result[string, string]
