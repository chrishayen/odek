...
std
  std.net
    std.net.http_listen
      fn (host: string, port: u16, handler: fn(http_request) -> http_response) -> result[void, string]
...
app_framework
  ...
  app_framework.resolve
    ...
    # dependency_injection
  app_framework.get
    fn (c: container, token: string) -> result[any, string]
  ...
  app_framework.handle
    ...
    -> std.json.encode
  app_framework.serve
    fn (r: router, host: string, port: u16) -> result[void, string]
