...
parser_generator
  ...
  parser_generator.tokenize
    fn (grammar: grammar_state, source: string) -> result[list[token], string]
  ...
  parser_generator.parse
    fn (table: parse_table, tokens: list[token]) -> result[parse_node, string]
