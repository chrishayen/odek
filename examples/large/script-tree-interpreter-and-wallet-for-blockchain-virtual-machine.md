...
scripttree
  ...
  wallet.verify_transaction
    ...
    -> std.crypto.schnorr_verify
  wallet.add_output
    @ (state: wallet_state, output_id: bytes, value: i64, script: list[opcode]) -> wallet_state
