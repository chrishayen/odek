...
type_checker
  ...
  type_checker.new_environment
    ...
    # construction
  type_checker.bind
    fn (env: type_environment, name: string, ty: inferred_type) -> type_environment
    + returns a new environment with the binding added
    # environment
  type_checker.infer
    fn (env: type_environment, node: ast_node) -> result[inferred_type, type_error]
    ...
    # inference
  type_checker.unify
    fn (a: inferred_type, b: inferred_type) -> result[inferred_type, type_error]
  ...
  type_checker.check_program
    fn (source: string) -> result[list[inferred_type], list[type_error]]
