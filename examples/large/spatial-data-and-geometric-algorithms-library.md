...
geometry
  ...
  geometry.segment_intersects
    fn (a1: point, a2: point, b1: point, b2: point) -> bool
  ...
  geometry.polygon_contains_point
    fn (vertices: list[point], p: point) -> bool
  ...
  geometry.polygon_union
    fn (a: list[point], b: list[point]) -> result[list[list[point]], string]
  ...
  geometry.polygon_intersection
    ...
    # boolean_op
  geometry.buffer
    fn (vertices: list[point], distance: f64) -> list[point]
