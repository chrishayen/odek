...
jsc
  jsc.tokenize
    ...
    # lexing
  jsc.parse_module
    @ (tokens: list[token]) -> result[module_ast, string]
    ...
    # parsing
  jsc.parse_file
    @ (path: string) -> result[module_ast, string]
  ...
  jsc.compile_string
    ...
    # pipeline
  jsc.compile_file
    @ (in_path: string, out_path: string, target: string) -> result[void, string]
