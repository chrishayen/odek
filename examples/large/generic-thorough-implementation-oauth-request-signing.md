...
oauth
  ...
  oauth.timestamp
    ...
    -> std.time.now_seconds
  oauth.base_string
    @ (method: string, url: string, params: map[string, string]) -> result[string, string]
    ...
    -> std.encoding.percent_encode
  oauth.signing_key
    @ (consumer_secret: string, token_secret: string) -> string
  ...
  oauth.sign_hmac_sha1
    @ (base_string: string, signing_key: string) -> string
  ...
  oauth.authorization_header
    ...
    -> std.encoding.percent_encode
  oauth.sign_request
    @ (method: string, url: string, body_params: map[string, string], consumer_key: string, consumer_secret: string, token: string, token_secret: string) -> result[string, string]
