...
nlp_pipeline
  nlp_pipeline.load_model
    @ (language: string, path: string) -> result[model_state, string]
  ...
  nlp_pipeline.tokenize
    @ (m: model_state, text: string) -> list[token_span]
