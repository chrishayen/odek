...
toml
  toml.tokenize
    fn (source: string) -> result[list[toml_token], string]
    ...
    # lexing
  toml.parse
    fn (tokens: list[toml_token]) -> result[toml_value, string]
    ...
    # parsing
  toml.decode
    fn (source: string) -> result[toml_value, string]
    ...
    -> toml.parse
  toml.get_string
    fn (root: toml_value, path: string) -> optional[string]
  ...
  toml.encode_value
    ...
    # encoding
  toml.encode
    fn (root: toml_value) -> result[string, string]
