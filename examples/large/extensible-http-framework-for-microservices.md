...
http_framework
  ...
  http_framework.use_middleware
    fn (r: router_state, mw: fn(fn(request) -> response) -> fn(request) -> response) -> router_state
  ...
  http_framework.handle_connection
    fn (r: router_state, conn: tcp_conn) -> void
  ...
  http_framework.serve
    fn (r: router_state, addr: string, port: u16) -> result[void, string]
  ...
  http_framework.json_response
    fn (status: i32, body: string) -> response
