...
etlkit
  ...
  etlkit.run_once
    ...
    # execution
  etlkit.run_stats
    fn (read: i64, written: i64, dropped: i64, started_millis: i64, ended_millis: i64) -> run_stats
    + builds a run statistics record
    # reporting
  etlkit.diff_index
    fn (target_count: i64, source_count: i64) -> i64
