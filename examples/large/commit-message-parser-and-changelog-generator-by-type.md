...
commit_changelog
  commit_changelog.parse_commit
    @ (raw: string) -> result[commit, string]
  ...
  commit_changelog.suggest_next_version
    @ (current: string, commits: list[commit]) -> result[string, string]
