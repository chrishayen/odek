...
workflow
  workflow.parse_template
    fn (raw: string) -> result[template, string]
  ...
  workflow.serialize_run
    ...
    -> std.json.encode
  workflow.load_run
    fn (raw: string) -> result[run, string]
