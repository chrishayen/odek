...
cassandra_driver
  ...
  cassandra_driver.connect
    @ (cluster: cluster_state) -> result[session_state, string]
  ...
  cassandra_driver.startup
    @ (session: session_state) -> result[session_state, string]
  ...
  cassandra_driver.prepare
    @ (session: session_state, statement: string) -> result[prepared_id, string]
  ...
  cassandra_driver.execute
    @ (session: session_state, prepared: prepared_id, params: list[bytes]) -> result[result_set, string]
  ...
  cassandra_driver.query
    @ (session: session_state, cql: string) -> result[result_set, string]
