...
std
  std.collections
    ...
    std.collections.pq_push
      fn (q: priority_queue, key: i32, value: i32) -> priority_queue
      + inserts value with the given key
      # collections
    std.collections.pq_pop_min
      fn (q: priority_queue) -> optional[tuple[i32, i32, priority_queue]]
