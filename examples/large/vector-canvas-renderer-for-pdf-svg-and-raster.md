...
vector_canvas
  ...
  vector_canvas.render_raster
    fn (canvas: canvas_state, pixel_width: i32, pixel_height: i32) -> bytes
    + returns a PNG image produced by rasterizing the operation list at the given resolution
    # raster_backend
  vector_canvas.save
    fn (canvas: canvas_state, path: string, format: string) -> result[void, string]
