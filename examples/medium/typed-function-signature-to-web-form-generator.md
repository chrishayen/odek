...
uiform
  ...
  uiform.decode_submission
    fn (fn: function_spec, body: string) -> result[map[string,string], string]
  ...
  uiform.render_result_page
    fn (fn: function_spec, result_text: string) -> string
