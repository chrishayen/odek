...
json_schema
  json_schema.compile
    @ (schema: json_value) -> result[compiled_schema, string]
  ...
  json_schema.validate
    @ (schema: compiled_schema, instance: json_value) -> list[violation]
  ...
  json_schema.validate_string
    @ (schema: compiled_schema, raw: string) -> result[list[violation], string]
