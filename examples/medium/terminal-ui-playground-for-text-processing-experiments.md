...
playground
  playground.new
    fn (executor: command_executor) -> playground_state
    + creates a playground bound to the given executor
    # construction
  playground.set_command
    fn (state: playground_state, command: string) -> playground_state
    + updates the command template
    # editing
  playground.set_input
    fn (state: playground_state, input: string) -> playground_state
    + updates the sample input
    # editing
  playground.run
    fn (state: playground_state) -> playground_state
    ...
    # execution
  playground.history
    fn (state: playground_state) -> list[run_record]
  ...
  playground.undo
    ...
    # history
  playground.render
    fn (state: playground_state, width: i32, height: i32) -> string
