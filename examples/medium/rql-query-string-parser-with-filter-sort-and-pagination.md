...
rql
  rql.parse_filter
    fn (expr: string) -> result[filter_expr, string]
    ...
    -> std.json.parse_value
  rql.parse_request
    fn (query: string) -> result[query_request, string]
