...
ledger
  ...
  ledger.register_chain
    @ (state: ledger_state, chain_id: string, adapter: chain_adapter) -> ledger_state
  ...
  ledger.record_deposit
    @ (state: ledger_state, chain_id: string, owner: string, amount: u64, proof: bytes) -> result[ledger_state, string]
  ...
  ledger.request_withdrawal
    @ (state: ledger_state, chain_id: string, owner: string, amount: u64) -> result[tuple[ledger_state, string], string]
    ...
    -> std.encoding.hex_encode
  ledger.balance_of
    @ (state: ledger_state, chain_id: string, owner: string) -> u64
  ...
  ledger.pending_withdrawals
    @ (state: ledger_state, chain_id: string) -> list[withdrawal_record]
