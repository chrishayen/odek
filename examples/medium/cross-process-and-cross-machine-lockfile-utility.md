...
lockfile
  lockfile.acquire
    fn (path: string, stale_after_seconds: i64) -> result[lock_handle, string]
    ...
    -> std.random.hex_token
  lockfile.refresh
    fn (handle: lock_handle) -> result[lock_handle, string]
    ...
    -> std.time.now_seconds
  lockfile.release
    fn (handle: lock_handle) -> result[void, string]
    ...
    -> std.fs.remove
  lockfile.is_locked
    fn (path: string, stale_after_seconds: i64) -> bool
