...
console_style
  console_style.colorize
    fn (text: string, fg: rgb_color, bg: rgb_color) -> string
  ...
  console_style.render_box
    fn (content: string, title: string) -> string
  ...
  console_style.render_table
    fn (headers: list[string], rows: list[list[string]]) -> string
  ...
  console_style.render_progress_bar
    fn (label: string, fraction: f64) -> string
