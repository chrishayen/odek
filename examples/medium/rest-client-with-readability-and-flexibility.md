...
rest_client
  ...
  rest_client.with_header
    @ (client: rest_client_state, name: string, value: string) -> rest_client_state
    + returns a client with the header appended to every request
    # configuration
  rest_client.request
    @ (client: rest_client_state, method: string, path: string, body: optional[json_value]) -> result[json_value, string]
