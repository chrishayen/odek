...
capnpgen
  capnpgen.new_struct
    @ (name: string) -> capnp_struct
    + creates an empty named struct descriptor
    # construction
  capnpgen.add_field
    @ (s: capnp_struct, name: string, type_name: string) -> capnp_struct
    + appends a field; its slot number is the current field count
    # construction
  capnpgen.map_type
    @ (src_type: string) -> result[string, string]
  ...
  capnpgen.render_struct
    @ (s: capnp_struct) -> result[string, string]
  ...
  capnpgen.render_schema
    @ (file_name: string, structs: list[capnp_struct]) -> result[string, string]
