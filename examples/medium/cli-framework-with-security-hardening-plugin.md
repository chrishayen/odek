...
cli
  cli.command_new
    ...
    # definition
  cli.command_flag
    @ (spec: command_spec, name: string, kind: flag_kind, required: bool) -> command_spec
    + appends a flag declaration
    # definition
  cli.parse_safe
    @ (spec: command_spec, args: list[string]) -> result[parsed_invocation, string]
  ...
  cli.plugin_store_open
    @ (root: string, plugin_id: string) -> result[plugin_store, string]
