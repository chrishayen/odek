...
stream
  ...
  stream.peek
    ...
    # intermediate
  stream.sorted
    @ (s: stream_state, less: fn(i64, i64) -> bool) -> stream_state
    ...
    # intermediate
  stream.for_each
    @ (s: stream_state, action: fn(i64) -> void) -> void
    + runs the pipeline and invokes action on every emitted item
    # terminal
  stream.reduce
    @ (s: stream_state, seed: i64, combine: fn(i64, i64) -> i64) -> i64
