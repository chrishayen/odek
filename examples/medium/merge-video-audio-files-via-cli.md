...
vidmerger
  vidmerger.probe_container
    @ (data: bytes) -> result[media_info, string]
  ...
  vidmerger.validate_compatible
    @ (infos: list[media_info]) -> result[void, string]
  ...
  vidmerger.build_concat_plan
    @ (paths: list[string]) -> result[concat_plan, string]
    ...
    -> vidmerger.validate_compatible
  vidmerger.concat
    @ (plan: concat_plan, output_path: string) -> result[void, string]
    ...
    -> std.fs.temp_path
  vidmerger.mux_audio
    @ (video_path: string, audio_path: string, output_path: string) -> result[void, string]
    ...
    -> std.fs.write_all
  vidmerger.merge
    @ (video_paths: list[string], audio_path: optional[string], output_path: string) -> result[void, string]
