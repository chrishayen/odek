...
getopt
  getopt.spec_new
    ...
    # construction
  getopt.spec_add
    fn (s: spec, short: string, long: string, has_arg: i32) -> result[spec, string]
    ...
    # specification
  getopt.parse
    fn (s: spec, args: list[string]) -> result[parse_result, string]
    ...
    -> getopt.spec_add
  getopt.value
    fn (r: parse_result, name: string) -> optional[string]
    ...
    # access
  getopt.count
    fn (r: parse_result, name: string) -> i32
    + returns how many times the flag appeared
    # access
  getopt.positionals
    fn (r: parse_result) -> list[string]
