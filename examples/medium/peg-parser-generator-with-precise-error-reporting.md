...
peg
  ...
  peg.compile
    ...
    # compilation
  peg.parse
    fn (p: parser, input: string) -> result[parse_tree, parse_error]
    ...
    # parsing
  peg.format_error
    fn (err: parse_error, input: string) -> string
    + returns a human-readable error with a caret pointing at the failure column
    # diagnostics
  peg.walk
    fn (tree: parse_tree, visitor: tree_visitor) -> void
