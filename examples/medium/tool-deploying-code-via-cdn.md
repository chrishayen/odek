...
deployer
  deployer.build_manifest
    @ (source_dir: string) -> result[manifest, string]
  ...
  deployer.upload_release
    @ (source_dir: string, release_id: string, store: object_store) -> result[manifest, string]
  ...
  deployer.write_pointer
    @ (release_id: string, store: object_store) -> result[void, string]
