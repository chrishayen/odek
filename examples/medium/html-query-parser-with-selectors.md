...
html_query
  html_query.parse
    ...
    # parsing
  html_query.select
    fn (root: dom_node, selector: string) -> result[list[dom_node], string]
  ...
  html_query.select_first
    fn (root: dom_node, selector: string) -> result[optional[dom_node], string]
    + returns the first match or none
    # selection
  html_query.text
    fn (node: dom_node) -> string
  ...
  html_query.attr
    ...
    # extraction
  html_query.children
    fn (node: dom_node) -> list[dom_node]
    + returns the direct element children of node
    # traversal
  html_query.parent
    fn (node: dom_node) -> optional[dom_node]
