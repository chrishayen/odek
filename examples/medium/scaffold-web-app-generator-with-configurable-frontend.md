...
scaffold
  ...
  scaffold.write_plan
    ...
    -> std.fs.write_all
  scaffold.generate
    fn (project: string, frontend: string, root: string) -> result[void, string]
