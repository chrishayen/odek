...
mql
  mql.tokenize
    fn (source: string) -> result[list[mql_token], string]
    ...
    # lexing
  mql.parse
    fn (tokens: list[mql_token]) -> result[mql_expr, string]
