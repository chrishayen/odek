...
license_report
  license_report.load_manifest
    @ (manifest_path: string) -> result[list[string], string]
  ...
  license_report.read_dependency_license
    @ (module_root: string) -> result[license_record, string]
  ...
  license_report.collect
    @ (manifest_path: string, modules_root: string) -> result[list[license_record], string]
  ...
  license_report.filter_disallowed
    @ (records: list[license_record], allowed: list[string]) -> list[license_record]
  ...
  license_report.format_table
    @ (records: list[license_record]) -> string
