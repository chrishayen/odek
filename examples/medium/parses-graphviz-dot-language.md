...
dot
  dot.tokenize
    @ (source: string) -> result[list[dot_token], string]
    ...
    -> std.strings.slice
  dot.parse
    @ (source: string) -> result[dot_graph, string]
