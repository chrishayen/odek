...
just
  just.map_slice
    @ (items: list[string], fn_id: string) -> list[string]
    + returns a new slice where each element is the result of applying fn_id
    # slice
  just.filter_slice
    @ (items: list[string], predicate_id: string) -> list[string]
    + returns only the elements for which the predicate returns true
    # slice
  just.reduce_slice
    @ (items: list[string], initial: string, fn_id: string) -> string
  ...
  just.unique
    ...
    # slice
  just.group_by
    @ (items: list[string], key_fn_id: string) -> map[string, list[string]]
  ...
  just.map_values
    ...
    # map
  just.merge
    @ (left: map[string, string], right: map[string, string]) -> map[string, string]
