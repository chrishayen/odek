...
pkgmgr
  pkgmgr.new_store
    fn (root_dir: string) -> store_state
  ...
  pkgmgr.parse_manifest
    ...
    # manifest
  pkgmgr.install
    fn (s: store_state, m: manifest) -> result[store_state, string]
