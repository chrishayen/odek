...
stack_enhancer
  ...
  stack_enhancer.load_source_window
    fn (path: string, line: i32, radius: i32) -> result[source_window, string]
  ...
  stack_enhancer.attach_excerpts
    fn (frames: list[frame], radius: i32) -> list[enhanced_frame]
