...
json_to_record
  json_to_record.infer_type
    @ (value: json_value) -> inferred_type
  ...
  json_to_record.merge_types
    @ (a: inferred_type, b: inferred_type) -> inferred_type
  ...
  json_to_record.from_samples
    @ (samples: list[string]) -> result[inferred_type, string]
  ...
  json_to_record.to_schema_text
    @ (schema: inferred_type, root_name: string) -> string
