...
std
  std.process
    std.process.run
      fn (cmd: string, args: list[string]) -> result[process_output, string]
...
sketch
  sketch.load
    fn (path: string) -> result[sketch_state, string]
