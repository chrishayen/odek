...
tracer
  ...
  tracer.capture_locals
    @ (frame: trace_frame) -> map[string, dynamic_value]
  ...
  tracer.capture_heap
    ...
    # inspection
  tracer.export
    @ (frames: list[trace_frame]) -> string
