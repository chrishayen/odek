...
streams
  streams.new_readable
    @ (high_water_mark: i32) -> readable_state
    + returns an empty readable stream with the given buffer threshold
    # construction
  streams.push
    @ (state: readable_state, chunk: bytes) -> tuple[bool, readable_state]
