...
load_gen
  load_gen.new_plan
    fn (method: string, url: string, total_requests: i32, concurrency: i32) -> load_plan
    + builds a plan describing the load to generate
    ? concurrency is clamped to total_requests
    # planning
  load_gen.run
    fn (plan: load_plan) -> load_report
