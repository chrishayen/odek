...
template_engine
  ...
  template_engine.register_template
    fn (state: engine_state, name: string, source: string) -> result[engine_state, string]
  ...
  template_engine.register_helper
    fn (state: engine_state, name: string, helper: helper_fn) -> engine_state
    + stores a helper callable that receives arguments and a context
    # registration
  template_engine.render
    fn (state: engine_state, name: string, context: map[string, string]) -> result[string, string]
  ...
  template_engine.render_with_parent
    fn (state: engine_state, child: string, parent: string, context: map[string, string]) -> result[string, string]
