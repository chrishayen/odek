...
keyboard_suggest
  ...
  keyboard_suggest.key_distance
    @ (layout: layout, a: string, b: string) -> f32
  ...
  keyboard_suggest.weighted_edit_distance
    @ (layout: layout, from: string, to: string) -> f32
  ...
  keyboard_suggest.new_dictionary
    @ (words: list[string]) -> dictionary
    + builds a dictionary from a word list
    # construction
  keyboard_suggest.suggest
    @ (layout: layout, dict: dictionary, input: string, max_results: i32) -> list[tuple[string, f32]]
