...
memcache
  memcache.connect
    fn (host: string, port: i32) -> result[memcache_client, string]
    + returns a client bound to the given memcache server
    # construction
    -> std.net.dial_tcp
  memcache.set
    fn (client: memcache_client, key: string, value: bytes, ttl_seconds: i32) -> result[void, string]
    ...
    -> std.net.read_line
  memcache.get
    fn (client: memcache_client, key: string) -> result[optional[bytes], string]
    ...
    -> std.net.read_n
  memcache.delete
    fn (client: memcache_client, key: string) -> result[bool, string]
    ...
    -> std.net.read_line
  memcache.increment
    fn (client: memcache_client, key: string, delta: i64) -> result[i64, string]
    ...
    -> std.net.read_line
  memcache.flush_all
    fn (client: memcache_client) -> result[void, string]
