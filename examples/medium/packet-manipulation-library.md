...
std
  ...
  std.bytes
    ...
    std.bytes.write_u16_be
      fn (buf: bytes, offset: i32, value: u16) -> result[bytes, string]
...
packet
  ...
  packet.build_ethernet
    fn (dst: bytes, src: bytes, ethertype: u16, payload: bytes) -> result[bytes, string]
