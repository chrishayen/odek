...
std
  ...
  std.concurrency
    std.concurrency.parallel_map
      fn (items: list[string], worker_count: i32, fn: fn(string) -> result[string, string]) -> list[result[string, string]]
...
featfmt
  ...
  featfmt.format_files
    fn (paths: list[string], worker_count: i32) -> list[result[string, string]]
