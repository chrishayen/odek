...
multimatch
  multimatch.automaton_build
    fn (patterns: list[string]) -> ac_automaton
    ...
    # construction
  multimatch.patterns
    fn (automaton: ac_automaton) -> list[string]
    + returns the patterns in the order they were added
    # inspection
  multimatch.find_all
    fn (automaton: ac_automaton, text: string) -> list[pattern_match]
  ...
  multimatch.find_first
    fn (automaton: ac_automaton, text: string) -> optional[pattern_match]
    + returns the first match by end offset
    - returns none when no pattern occurs
    # matching
  multimatch.replace_all
    fn (automaton: ac_automaton, text: string, replacements: list[string]) -> string
