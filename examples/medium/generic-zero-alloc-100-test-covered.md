...
quadtree
  quadtree.new
    @ (min_x: f64, min_y: f64, max_x: f64, max_y: f64, capacity: i32) -> quadtree_state
  ...
  quadtree.query_range
    @ (state: quadtree_state, min_x: f64, min_y: f64, max_x: f64, max_y: f64) -> list[string]
  ...
  quadtree.query_radius
    @ (state: quadtree_state, cx: f64, cy: f64, radius: f64) -> list[string]
    + returns ids of all points within Euclidean distance `radius` of (cx, cy)
    # radius_query
  quadtree.size
    @ (state: quadtree_state) -> i32
