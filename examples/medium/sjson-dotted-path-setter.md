...
sjson
  sjson.parse_path
    fn (path: string) -> list[path_segment]
    ...
    # path_parsing
  sjson.set_string
    fn (doc: string, path: string, value: string) -> result[string, string]
    ...
    -> std.json.encode
  sjson.set_number
    fn (doc: string, path: string, value: f64) -> result[string, string]
    ...
    -> std.json.encode
  sjson.set_bool
    fn (doc: string, path: string, value: bool) -> result[string, string]
    + returns the JSON document with value set as a bool at path
    # set
    -> std.json.parse
    -> std.json.encode
  sjson.set_raw
    fn (doc: string, path: string, raw_json: string) -> result[string, string]
    ...
    -> std.json.encode
  sjson.delete
    fn (doc: string, path: string) -> result[string, string]
