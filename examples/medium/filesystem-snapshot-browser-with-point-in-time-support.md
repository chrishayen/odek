...
snapshot_browser
  snapshot_browser.discover_versions
    fn (live_path: string, snapshot_roots: list[string]) -> result[list[file_version], string]
  ...
  snapshot_browser.load_version
    fn (version: file_version) -> result[bytes, string]
  ...
  snapshot_browser.diff_versions
    fn (a: bytes, b: bytes) -> list[diff_hunk]
  ...
  snapshot_browser.restore_version
    fn (version: file_version, target_path: string) -> result[void, string]
