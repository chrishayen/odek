...
config_renderer
  ...
  config_renderer.apply_all
    @ (state: renderer_state) -> result[list[string], string]
  ...
  config_renderer.reload_changed
    @ (state: renderer_state, changed: list[string]) -> result[void, string]
