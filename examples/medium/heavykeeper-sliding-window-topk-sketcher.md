...
topk
  topk.new
    fn (k: i32, width: i32, depth: i32, decay: f64) -> result[topk_state, string]
    ...
    # construction
  topk.observe
    fn (state: topk_state, item: bytes, count: i64) -> topk_state
  ...
  topk.new_windowed
    ...
    # construction
  topk.tick
    fn (state: topk_state) -> topk_state
