...
std
  std.http
    std.http.get
      ...
      # network
    std.http.post_bytes
      fn (url: string, body: bytes, content_type: string) -> result[http_response, string]
...
object_store_client
  ...
  object_store_client.upload
    fn (state: client_state, data: bytes, content_type: string) -> result[string, string]
  ...
  object_store_client.download
    fn (state: client_state, file_id: string) -> result[bytes, string]
  ...
  object_store_client.delete
    fn (state: client_state, file_id: string) -> result[void, string]
