...
std
  ...
  std.json
    std.json.parse
      fn (raw: string) -> result[void, parse_error]
...
config_validator
  config_validator.detect_format
    fn (path: string, content: string) -> config_format
  ...
  config_validator.validate_file
    fn (path: string) -> result[void, validation_error]
