...
structconc
  structconc.new_scope
    ...
    # construction
  structconc.spawn
    fn (scope: scope_state, task_id: string, work: task_fn) -> scope_state
    ...
    # spawn
  structconc.wait_all
    fn (scope: scope_state) -> result[map[string, string], string]
