...
std
  ...
  std.json
    std.json.parse
      fn (raw: string) -> result[config_value, string]
...
hydra
  hydra.load_file
    fn (path: string) -> result[config_value, string]
