...
lifecycle
  lifecycle.new
    ...
    # construction
  lifecycle.register
    @ (state: lifecycle_state, name: string, deps: list[string], start_fn: string, stop_fn: string) -> result[lifecycle_state, string]
  ...
  lifecycle.start_order
    @ (state: lifecycle_state) -> result[list[string], string]
    ...
    # planning
  lifecycle.start_all
    @ (state: lifecycle_state) -> result[lifecycle_state, string]
  ...
  lifecycle.stop_all
    ...
    # shutdown
  lifecycle.status
    @ (state: lifecycle_state, name: string) -> result[string, string]
