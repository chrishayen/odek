...
datetime
  datetime.parse
    fn (text: string, layout: string) -> result[civil_time, string]
    ...
    # parsing
  datetime.format
    fn (civil: civil_time, layout: string) -> string
    + renders a civil time using the given layout
    + pads numeric fields to the layout's width
    # formatting
  datetime.convert_zone
    fn (civil: civil_time, from_zone: string, to_zone: string) -> result[civil_time, string]
