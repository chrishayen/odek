...
colfer
  colfer.parse_schema
    @ (source: string) -> result[list[struct_decl], string]
  ...
  colfer.generate_from_file
    @ (schema_path: string, out_path: string) -> result[void, string]
