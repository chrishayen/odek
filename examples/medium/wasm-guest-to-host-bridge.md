...
wasm_bridge
  ...
  wasm_bridge.invoke_guest
    fn (state: bridge_state, export_name: string, args: list[wasm_value]) -> result[tuple[wasm_value, bridge_state], string]
    ...
    -> std.bytes.read_u32_le
  wasm_bridge.free
    fn (state: bridge_state, offset: i32) -> result[bridge_state, string]
