...
concurrent_map
  ...
  concurrent_map.put
    ...
    -> std.sync.mutex_with
  concurrent_map.get
    fn (m: cmap_state, key: bytes) -> optional[bytes]
  ...
  concurrent_map.remove
    fn (m: cmap_state, key: bytes) -> bool
