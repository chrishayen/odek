...
stats
  stats.mean
    fn (xs: list[f64]) -> result[f64, string]
  ...
  stats.pearson_correlation
    fn (xs: list[f64], ys: list[f64]) -> result[f64, string]
