...
commit_lint
  ...
  commit_lint.check_range
    fn (rules: ruleset, repo_path: string, from_ref: string, to_ref: string) -> result[list[tuple[string, list[string]]], string]
