...
chem_parse
  chem_parse.detect_format
    ...
    # format_detection
  chem_parse.parse
    fn (raw: string, format: string) -> result[chem_result, string]
  ...
  chem_parse.vibrational_modes
    fn (res: chem_result) -> list[tuple[f64, f64]]
