...
market_client
  market_client.new
    fn (base_url: string) -> market_client_state
    + creates a client pointed at the given base URL
    # construction
  market_client.get_ticker
    fn (state: market_client_state, coin_id: string) -> result[map[string, string], string]
  ...
  market_client.list_coins
    fn (state: market_client_state) -> result[list[map[string, string]], string]
