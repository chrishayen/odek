...
repo_insights
  repo_insights.load_history
    fn (repo: repo_adapter) -> result[history, string]
  ...
  repo_insights.contributors
    fn (h: history) -> list[contributor_record]
