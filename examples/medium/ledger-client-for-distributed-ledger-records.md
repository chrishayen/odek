...
ledger_client
  ...
  ledger_client.get_record
    fn (state: ledger_client_state, key: string) -> result[optional[bytes], string]
  ...
  ledger_client.put_record
    fn (state: ledger_client_state, key: string, value: bytes) -> result[string, string]
