...
webfw
  webfw.new_app
    ...
    # construction
  webfw.route
    fn (a: app, method: string, pattern: string, handler: http_handler) -> result[app, string]
    ...
    # routing
  webfw.use
    fn (a: app, mw: middleware) -> app
    + appends a middleware to the chain run before handlers
    # middleware
  webfw.match_route
    fn (a: app, method: string, path: string) -> result[route_match, string]
