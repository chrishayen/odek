...
inject
  inject.new_container
    ...
    # construction
  inject.provide
    fn (state: container_state, produces: list[string], consumes: list[string], factory_id: string) -> result[container_state, string]
  ...
  inject.resolve_order
    fn (state: container_state, required_types: list[string]) -> result[list[string], string]
    ...
    # planning
  inject.invoke
    fn (state: container_state, handler_consumes: list[string], run_factory: fn(string, map[string,bytes]) -> result[map[string,bytes],string]) -> result[map[string,bytes], string]
    ...
    -> inject.resolve_order
  inject.check
    fn (state: container_state, handler_consumes: list[string]) -> result[void, string]
