...
std
  std.image
    std.image.decode_jpeg
      fn (data: bytes) -> result[raster, string]
...
image_resize
  image_resize.detect_format
    fn (data: bytes) -> result[image_format, string]
