...
speller
  speller.new
    ...
    # construction
  speller.train
    fn (state: speller_state, text: string) -> void
  ...
  speller.load_vocabulary
    fn (state: speller_state, words: list[string], frequencies: list[i64]) -> result[void, string]
  ...
  speller.candidates
    ...
    # candidate_ranking
  speller.correct
    fn (state: speller_state, word: string) -> string
