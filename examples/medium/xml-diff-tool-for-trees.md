...
xml_diff
  xml_diff.compare_nodes
    fn (left: xml_node, right: xml_node) -> list[xml_difference]
  ...
  xml_diff.compare_files
    fn (left_path: string, right_path: string) -> result[list[xml_difference], string]
  ...
  xml_diff.compare_folders
    fn (left_dir: string, right_dir: string) -> result[folder_diff, string]
