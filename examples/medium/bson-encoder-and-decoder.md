...
bson
  ...
  bson.decode_document
    fn (data: bytes) -> result[list[tuple[string, bson_value]], string]
    ...
    -> std.encoding.decode_i32_le
  bson.decode_value
    fn (data: bytes, offset: i32) -> result[tuple[string, bson_value, i32], string]
    ...
    -> std.encoding.decode_f64_le
  bson.read_cstring
    fn (data: bytes, offset: i32) -> result[tuple[string, i32], string]
