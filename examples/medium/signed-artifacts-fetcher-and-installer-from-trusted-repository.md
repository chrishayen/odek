...
signed_artifacts
  signed_artifacts.fetch_manifest
    @ (repo_url: string, name: string) -> result[manifest, string]
  ...
  signed_artifacts.verify_artifact
    @ (data: bytes, manifest: manifest, trusted_key: bytes) -> result[void, string]
  ...
  signed_artifacts.install
    @ (repo_url: string, name: string, install_path: string, trusted_key: bytes) -> result[void, string]
  ...
  signed_artifacts.current_version
    @ (install_path: string) -> result[string, string]
