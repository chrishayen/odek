...
site_deploy
  site_deploy.plan
    fn (root: string, remote_index: map[string, string]) -> result[deploy_plan, string]
  ...
  site_deploy.upload_file
    fn (local_path: string, remote_key: string, content_type: string) -> result[void, string]
    ...
    -> std.mime.guess
  site_deploy.execute
    fn (plan: deploy_plan) -> result[deploy_report, string]
