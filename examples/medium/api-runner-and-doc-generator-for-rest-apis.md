...
api_runner
  api_runner.load_spec
    fn (path: string) -> result[api_spec, string]
    ...
    -> std.yaml.parse
  api_runner.run_case
    fn (base_url: string, case: endpoint_case) -> case_result
    ...
    -> std.http.request
  api_runner.run_all
    fn (base_url: string, spec: api_spec) -> run_report
