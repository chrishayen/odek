...
nmea
  nmea.verify_checksum
    fn (sentence: string) -> result[string, string]
  ...
  nmea.sentence_type
    ...
    -> std.strings.split
  nmea.parse_lat_lon
    fn (raw: string, hemisphere: string) -> result[f64, string]
    ...
    -> std.parse.parse_f64
  nmea.parse_gga
    fn (payload: string) -> result[fix_record, string]
  ...
  nmea.parse_rmc
    ...
    -> std.parse.parse_f64
  nmea.parse_sentence
    fn (sentence: string) -> result[fix_record, string]
