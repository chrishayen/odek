...
style_linter
  ...
  style_linter.set_rule
    @ (config: lint_config, rule_name: string, severity: string) -> result[lint_config, string]
  ...
  style_linter.lint_source
    @ (config: lint_config, path: string, source: string) -> list[violation]
  ...
  style_linter.lint_file
    @ (config: lint_config, path: string) -> result[list[violation], string]
