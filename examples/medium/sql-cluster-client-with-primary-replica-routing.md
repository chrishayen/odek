...
dbcluster
  dbcluster.new
    fn (hosts: list[host_config]) -> cluster_state
  ...
  dbcluster.refresh_health
    fn (state: cluster_state, probe: fn(host_config) -> result[host_role, string]) -> cluster_state
  ...
  dbcluster.pick_primary
    fn (state: cluster_state) -> result[host_config, string]
  ...
  dbcluster.execute_write
    fn (state: cluster_state, query: string, params: list[string]) -> result[query_result, string]
