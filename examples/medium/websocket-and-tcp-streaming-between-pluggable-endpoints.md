...
std
  std.net
    std.net.dial_tcp
      fn (host: string, port: i32) -> result[stream, string]
...
streamcat
  streamcat.open_ws
    fn (url: string) -> result[stream, string]
  ...
  streamcat.open_stdio
    ...
    # endpoints
  streamcat.join
    fn (a: stream, b: stream) -> result[join_stats, string]
