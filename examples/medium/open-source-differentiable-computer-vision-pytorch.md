...
diff_vision
  diff_vision.from_image
    @ (pixels: bytes, width: i32, height: i32, channels: i32) -> tensor
  ...
  diff_vision.normalize
    @ (t: tensor, mean: list[f32], std: list[f32]) -> tensor
