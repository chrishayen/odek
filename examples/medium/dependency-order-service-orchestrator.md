...
orchestrator
  ...
  orchestrator.register
    fn (state: orchestrator_state, name: string, depends_on: list[string], runner: service_runner) -> result[orchestrator_state, string]
    + returns a new state with the service added
    - returns error when the name is already registered
    # registration
  orchestrator.resolve_order
    fn (state: orchestrator_state) -> result[list[string], string]
  ...
  orchestrator.start_all
    fn (state: orchestrator_state) -> result[orchestrator_state, string]
  ...
  orchestrator.stop_all
    ...
    # shutdown
  orchestrator.health
    fn (state: orchestrator_state, name: string) -> result[string, string]
