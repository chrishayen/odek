...
regexgen
  regexgen.parse
    @ (pattern: string) -> result[regex_node, string]
  ...
  regexgen.generate_node
    ...
    -> std.random.int_range
  regexgen.generate
    @ (pattern: string, seed: u64, star_cap: i32) -> result[string, string]
