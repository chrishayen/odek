...
schema_codec
  ...
  schema_codec.set_field
    ...
    # encoding
  schema_codec.freeze
    fn (b: struct_builder) -> bytes
    + serializes the builder into the wire format
    # encoding
  schema_codec.open_reader
    fn (def: struct_def, raw: bytes) -> result[struct_reader, string]
  ...
  schema_codec.get_field
    fn (r: struct_reader, field: string) -> result[field_value, string]
