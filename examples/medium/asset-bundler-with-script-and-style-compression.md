...
asset_bundler
  ...
  asset_bundler.bundle
    fn (sources: list[string], base_dir: string) -> result[tuple[string, bytes], string]
  ...
  asset_bundler.rewrite_markup
    fn (markup: string, bundle_url: string, kind: string) -> string
  ...
  asset_bundler.persist
    fn (cache_dir: string, name: string, data: bytes) -> result[void, string]
