...
input_devices
  ...
  input_devices.move_pointer
    fn (handle: device_handle, x: i32, y: i32) -> result[void, string]
    + moves the pointer to absolute screen coordinates
    # synthesis
  input_devices.click_button
    fn (handle: device_handle, button: pointer_button) -> result[void, string]
    + synthesizes a full press-release of a pointer button
    # synthesis
  input_devices.next_event
    fn (handle: device_handle) -> result[optional[input_event], string]
