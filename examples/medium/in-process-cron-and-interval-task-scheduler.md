...
scheduler
  scheduler.new
    ...
    # construction
  scheduler.add_cron
    fn (s: scheduler_state, id: string, expr: string) -> result[void, string]
  ...
  scheduler.next_fire_at
    fn (s: scheduler_state, id: string) -> optional[i64]
