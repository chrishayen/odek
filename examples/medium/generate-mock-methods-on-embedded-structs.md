...
moxie
  ...
  moxie.find_embedded_methods
    @ (ast: source_ast, host_type: string) -> list[method_sig]
  ...
  moxie.render_call_recorder
    @ (type_name: string, methods: list[method_sig]) -> string
  ...
  moxie.render_mock_methods
    ...
    # codegen
  moxie.generate
    @ (src_path: string, host_type: string, out_path: string) -> result[void, string]
