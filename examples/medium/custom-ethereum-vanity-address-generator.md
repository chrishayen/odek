...
vanity
  vanity.derive_address
    @ (private_key: bytes) -> result[string, string]
  ...
  vanity.matches_pattern
    @ (address: string, prefix: string, suffix: string) -> bool
    ...
    # matching
  vanity.find
    @ (prefix: string, suffix: string, max_attempts: u64) -> result[tuple[bytes, string], string]
