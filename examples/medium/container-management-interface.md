...
container_manager
  container_manager.list_containers
    fn (client: runtime_client) -> result[list[container_info], string]
  ...
  container_manager.stream_logs
    fn (client: runtime_client, id: string, on_line: log_callback) -> result[void, string]
