...
tpl_testgen
  tpl_testgen.describe_function
    fn (name: string, params: list[param], returns: list[string]) -> function_spec
  ...
  tpl_testgen.bindings
    fn (f: function_spec, case_name: string) -> map[string, string]
    + returns the placeholder-to-text map for rendering a single case
    # binding
  tpl_testgen.render
    fn (tpl: template, bindings: map[string, string]) -> string
  ...
  tpl_testgen.render_file
    fn (tpl: template, f: function_spec, cases: list[string]) -> string
