...
issue_picker
  issue_picker.new
    fn (adapter: tracker_adapter) -> picker_state
    + creates a picker backed by the given tracker adapter with an empty query
    # construction
  issue_picker.load_issues
    fn (state: picker_state, project: string) -> result[picker_state, string]
