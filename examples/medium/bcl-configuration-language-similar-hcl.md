...
config_lang
  config_lang.tokenize
    @ (source: string) -> result[list[config_token], string]
    ...
    -> std.strings.is_alpha
  config_lang.parse
    @ (tokens: list[config_token]) -> result[config_node, string]
