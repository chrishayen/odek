...
http_client
  ...
  http_client.set_body
    fn (request: request_state, body: bytes) -> request_state
    + sets the request body
    # construction
  http_client.send
    fn (client: client_state, request: request_state) -> result[http_response, string]
