...
std
  std.net
    std.net.open_packet_source
      fn (interface_name: string) -> result[packet_source, string]
      ...
      # network
    std.net.next_packet
      fn (src: packet_source) -> result[bytes, string]
...
dns_monitor
  dns_monitor.decode_dns
    fn (packet: bytes) -> result[dns_message, string]
