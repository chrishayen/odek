...
version_resolver
  ...
  version_resolver.read_pinned_version
    @ (version_file_path: string) -> result[string, string]
  ...
  version_resolver.pin_version
    @ (dir: string, filename: string, version: string) -> result[void, string]
    + writes the version into dir/filename
    - returns error on filesystem failure
    # writing
    -> std.fs.write_all
  version_resolver.resolve
    @ (start_dir: string, filename: string, global_default: string) -> string
  ...
  version_resolver.set_global
    @ (global_config_path: string, version: string) -> result[void, string]
