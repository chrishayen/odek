...
geospatial
  geospatial.point_in_polygon
    @ (lat: f64, lon: f64, polygon: list[tuple[f64, f64]]) -> bool
  ...
  geospatial.polygon_area_sq_meters
    @ (polygon: list[tuple[f64, f64]]) -> f64
  ...
  geospatial.bounding_box
    @ (points: list[tuple[f64, f64]]) -> result[tuple[f64, f64, f64, f64], string]
    + returns (min_lat, min_lon, max_lat, max_lon)
    - returns error when points is empty
    # bounding_box
  geospatial.simplify_line
    @ (points: list[tuple[f64, f64]], tolerance_meters: f64) -> list[tuple[f64, f64]]
    ...
    # simplification
  geospatial.centroid
    @ (polygon: list[tuple[f64, f64]]) -> result[tuple[f64, f64], string]
