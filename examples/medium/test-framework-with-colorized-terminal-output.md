...
test_framework
  ...
  test_framework.assert_equal
    @ (suite: suite_state, label: string, expected: string, actual: string) -> suite_state
  ...
  test_framework.assert_true
    @ (suite: suite_state, label: string, condition: bool) -> suite_state
    + records a passing result when condition is true
    - records a failing result when condition is false
    # assertion
  test_framework.run
    @ (suite: suite_state, body: func(suite_state) -> suite_state) -> suite_state
