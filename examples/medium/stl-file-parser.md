...
stl
  ...
  stl.parse_binary
    ...
    -> std.binary.read_f32_le
  stl.triangles
    fn (mesh: stl_mesh) -> list[triangle]
    + returns every triangle with its three vertices and normal
    # query
  stl.triangle_count
    fn (mesh: stl_mesh) -> i32
    + returns the number of triangles in the mesh
    # query
  stl.bounding_box
    fn (mesh: stl_mesh) -> tuple[vec3, vec3]
