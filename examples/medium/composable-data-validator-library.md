...
validator
  ...
  validator.boolean
    ...
    # primitives
  validator.optional
    @ (inner: validator_handle) -> validator_handle
    + returns a validator that also accepts null
    # combinators
  validator.list_of
    @ (element: validator_handle) -> validator_handle
    + returns a validator that checks every item against element
    # combinators
  validator.object
    @ (fields: map[string, validator_handle]) -> validator_handle
