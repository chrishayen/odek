...
dlock
  dlock.new_token
    ...
    -> std.encoding.hex_encode
  dlock.try_acquire
    fn (backend: kv_backend, key: string, ttl_millis: i64) -> result[lock_handle, string]
    ...
    -> std.time.now_millis
  dlock.release
    fn (backend: kv_backend, handle: lock_handle) -> result[void, string]
    ...
    # release
  dlock.refresh
    fn (backend: kv_backend, handle: lock_handle, ttl_millis: i64) -> result[lock_handle, string]
