...
image_resize
  image_resize.new_image
    fn (width: i32, height: i32, pixels: bytes) -> result[raster_image, string]
    + wraps pixels as an RGBA raster image
    - returns error when pixels length does not equal width*height*4
    # construction
  image_resize.nearest
    fn (src: raster_image, new_width: i32, new_height: i32) -> result[raster_image, string]
  ...
  image_resize.compare_ssim
    fn (a: raster_image, b: raster_image) -> result[f64, string]
