...
tilegrid
  ...
  tilegrid.export_binary
    @ (grid: grid_state, path: string) -> result[void, string]
    + writes the grid to a file as width, height, and flat cell data
    # io
    -> std.fs.write_all
  tilegrid.import_binary
    @ (path: string) -> result[grid_state, string]
