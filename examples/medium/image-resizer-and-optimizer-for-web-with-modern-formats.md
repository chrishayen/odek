...
std
  ...
  std.image
    std.image.decode
      ...
      # image
    std.image.encode
      fn (img: image, format: string, quality: i32) -> result[bytes, string]
...
image_optim
  ...
  image_optim.fit_within
    fn (img: image, max_width: i32, max_height: i32) -> image
  ...
  image_optim.best_format_for
    fn (accept_header: string) -> string
  ...
  image_optim.process_file
    fn (input_path: string, output_path: string, max_width: i32, max_height: i32, format: string, quality: i32) -> result[void, string]
