...
pdf_service
  pdf_service.parse_spec
    fn (raw: bytes) -> result[document_spec, string]
    ...
    -> std.json.parse
  pdf_service.layout
    fn (spec: document_spec, page_width: f64, page_height: f64) -> laid_out_document
    ...
    # layout
  pdf_service.render
    fn (laid_out: laid_out_document) -> bytes
  ...
  pdf_service.load_image
    fn (path: string) -> result[image_resource, string]
