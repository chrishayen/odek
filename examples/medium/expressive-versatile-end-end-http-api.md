...
apitest
  ...
  apitest.expect_json_field
    @ (resp: http_response, pointer: string, expected: string) -> optional[string]
  ...
  apitest.run_assertions
    @ (resp: http_response, checks: list[assertion]) -> list[string]
