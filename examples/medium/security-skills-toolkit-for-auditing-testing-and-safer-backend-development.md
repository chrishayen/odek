...
std
  ...
  std.regex
    std.regex.compile
      ...
      # pattern_matching
    std.regex.find_all
      fn (r: regex, input: string) -> list[string]
...
security_skills
  ...
  security_skills.format_report
    fn (findings: list[finding]) -> string
