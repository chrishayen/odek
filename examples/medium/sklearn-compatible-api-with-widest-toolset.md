...
features
  features.fit_standard_scaler
    @ (columns: list[list[f64]]) -> result[scaler_params, string]
  ...
  features.transform_standard_scaler
    @ (params: scaler_params, columns: list[list[f64]]) -> result[list[list[f64]], string]
  ...
  features.select_by_variance_threshold
    @ (columns: list[list[f64]], threshold: f64) -> result[list[i32], string]
