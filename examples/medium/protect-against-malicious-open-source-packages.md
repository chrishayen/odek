...
malice_scan
  malice_scan.parse_manifest
    @ (text: string) -> result[list[package_ref], string]
  ...
  malice_scan.lookup_package
    @ (pkg: package_ref, db_url: string) -> result[list[advisory], string]
  ...
  malice_scan.scan_manifest
    @ (path: string, db_url: string) -> result[scan_report, string]
