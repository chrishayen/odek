...
embeddings
  embeddings.load
    @ (path: string) -> result[embedding_table, string]
  ...
  embeddings.most_similar
    @ (table: embedding_table, word: string, k: i32) -> result[list[tuple[string, f32]], string]
