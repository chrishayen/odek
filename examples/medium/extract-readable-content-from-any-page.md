...
std
  std.html
    ...
    std.html.text_content
      ...
      # html
    std.html.find_all
      @ (node: html_node, tag: string) -> list[html_node]
...
readable
  readable.extract
    @ (html: string) -> result[article, string]
