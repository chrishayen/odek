...
typed_graphql
  ...
  typed_graphql.register_type
    fn (schema: schema_state, name: string, fields: map[string, string]) -> result[schema_state, string]
  ...
  typed_graphql.register_query
    fn (schema: schema_state, name: string, return_type: string, resolve: closure[map[string, string]]) -> schema_state
  ...
  typed_graphql.validate
    fn (schema: schema_state, query: query_ast) -> result[void, list[string]]
  ...
  typed_graphql.execute
    fn (schema: schema_state, query: query_ast, variables: map[string, string]) -> result[string, string]
