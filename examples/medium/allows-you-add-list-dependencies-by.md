...
manifest_deps
  manifest_deps.list
    ...
    -> std.toml.parse
  manifest_deps.add
    @ (path: string, name: string, version: string) -> result[void, string]
  ...
  manifest_deps.remove
    @ (path: string, name: string) -> result[void, string]
