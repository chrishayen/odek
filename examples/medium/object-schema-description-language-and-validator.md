...
schema
  ...
  schema.max
    ...
    # schema_builder
  schema.pattern
    fn (node: schema_node, regex: string) -> schema_node
    + attaches a regex pattern constraint to a string node
    # schema_builder
  schema.validate
    fn (node: schema_node, value: dynamic_value) -> list[validation_error]
