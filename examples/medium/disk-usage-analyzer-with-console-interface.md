...
std
  ...
  std.term
    ...
    std.term.read_key
      ...
      # terminal
    std.term.draw
      fn (frame: list[string]) -> result[void, string]
...
disk_usage
  disk_usage.scan
    fn (root: string) -> result[disk_tree, string]
  ...
  disk_usage.handle_key
    ...
    # navigation
  disk_usage.run_tui
    fn (root: string) -> result[void, string]
