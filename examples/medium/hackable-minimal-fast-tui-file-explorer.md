...
file_explorer
  file_explorer.open
    @ (path: string) -> result[explorer_state, string]
  ...
  file_explorer.set_filter
    @ (state: explorer_state, pattern: string) -> explorer_state
