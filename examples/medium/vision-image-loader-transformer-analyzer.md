...
std
  std.image_codec
    std.image_codec.decode
      fn (data: bytes) -> result[raw_image, string]
    ...
    std.image_codec.encode_png
      fn (img: raw_image) -> result[bytes, string]
