...
typ
  typ.none_string
    ...
    # construction
  typ.some_string
    fn (s: string) -> optional[string]
    + returns a present string value
    # construction
  typ.to_i64
    fn (v: dyn_value) -> result[i64, string]
  ...
  typ.get_path
    ...
    # extraction
  typ.get_i64
    fn (root: dyn_value, path: string) -> result[i64, string]
