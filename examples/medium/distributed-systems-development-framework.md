...
framework
  ...
  framework.lookup_service
    ...
    # discovery
  framework.dispatch
    fn (state: node_state, service_name: string, payload: bytes) -> result[bytes, string]
  ...
  framework.expire_stale_peers
    fn (state: node_state, max_age_millis: i64) -> node_state
