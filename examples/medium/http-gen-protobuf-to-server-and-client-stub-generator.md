...
httpgen
  httpgen.parse_proto
    fn (source: string) -> result[proto_file, string]
  ...
  httpgen.extract_http_routes
    fn (file: proto_file) -> list[route_spec]
  ...
  httpgen.render_server_handler
    fn (service: string, routes: list[route_spec]) -> string
  ...
  httpgen.render_client_caller
    ...
    # codegen
  httpgen.generate
    fn (proto_path: string, out_server: string, out_client: string) -> result[void, string]
