...
cache
  ...
  cache.set
    ...
    -> std.sync.unlock
  cache.get
    fn (state: cache_state, key: bytes) -> optional[bytes]
    ...
    -> std.sync.unlock
  cache.delete
    fn (state: cache_state, key: bytes) -> bool
