...
telemetry
  ...
  telemetry.collect_once
    ...
    -> std.host.hostname
  telemetry.eval_expr
    @ (expr: string, metrics: map[string, f64]) -> result[f64, string]
    ...
    # expression_eval
  telemetry.forward
    @ (samples: list[sample], sink: sample_sink) -> result[void, string]
