...
schema_match
  schema_match.compile
    fn (expression: string) -> result[schema_program, string]
  ...
  schema_match.match_value
    fn (program: schema_program, value: json_value) -> result[void, list[string]]
  ...
  schema_match.match_json
    fn (expression: string, raw_json: string) -> result[void, list[string]]
