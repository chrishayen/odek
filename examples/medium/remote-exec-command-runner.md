...
remote_exec
  ...
  remote_exec.run_once
    @ (endpoint: string, username: string, password: string, program: string, args: list[string]) -> result[command_output, string]
  ...
  remote_exec.close_session
    @ (session: session) -> result[void, string]
