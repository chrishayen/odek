...
qbuild
  qbuild.insert
    fn (table: string, record: map[string, string]) -> tuple[string, list[string]]
    ...
    # insert
  qbuild.update
    fn (table: string, record: map[string, string], where: map[string, string]) -> tuple[string, list[string]]
    ...
    # update
  qbuild.select_by
    fn (table: string, columns: list[string], where: map[string, string]) -> tuple[string, list[string]]
    + returns a SELECT statement for the given columns filtered by equality predicates
    # select
  qbuild.delete_by
    fn (table: string, where: map[string, string]) -> tuple[string, list[string]]
