...
streams
  streams.new_graph
    ...
    # construction
  streams.add_block
    fn (g: graph_state, id: string, kind: string, config: map[string, string]) -> result[graph_state, string]
    ...
    # topology
  streams.connect
    fn (g: graph_state, from_id: string, to_id: string) -> result[graph_state, string]
