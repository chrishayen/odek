...
elmish
  elmish.make_app
    fn (init: app_state, update: update_fn, view: view_fn) -> app
    + returns an app bundling the initial state and the two pure functions
    # construction
  elmish.dispatch
    fn (current: app, msg: message) -> app
