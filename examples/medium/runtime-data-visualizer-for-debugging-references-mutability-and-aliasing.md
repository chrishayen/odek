...
std
  std.collections
    std.collections.hashmap_new
      fn () -> map[i64, object_snapshot]
      + returns an empty object id map
      # collections
    std.collections.hashmap_put
      fn (m: map[i64, object_snapshot], key: i64, value: object_snapshot) -> map[i64, object_snapshot]
      + returns a new map with key bound to value
      # collections
    std.collections.hashmap_contains
      fn (m: map[i64, object_snapshot], key: i64) -> bool
      + returns true when key is present
      # collections

memviz
  memviz.snapshot
    fn (root: dynamic_value) -> object_graph
