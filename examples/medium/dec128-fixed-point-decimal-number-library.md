...
dec128
  dec128.from_string
    fn (text: string) -> result[dec128_value, string]
  ...
  dec128.mul
    ...
    -> std.math.mul_u64_wide
  dec128.div
    fn (a: dec128_value, b: dec128_value, result_scale: u8) -> result[dec128_value, string]
    + returns the quotient rounded half-to-even at the requested scale
    - returns error when b is zero
    # arithmetic
    -> std.math.div_u128_by_u64
  dec128.compare
    fn (a: dec128_value, b: dec128_value) -> i8
