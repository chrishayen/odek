...
push_server
  ...
  push_server.register_device
    fn (state: push_state, device_token: string, user_id: string) -> result[push_state, string]
  ...
  push_server.unregister_device
    fn (state: push_state, device_token: string) -> push_state
  ...
  push_server.enqueue_message
    fn (state: push_state, user_id: string, title: string, body: string) -> tuple[push_state, string]
