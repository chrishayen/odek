...
triangulate
  triangulate.polygon_to_triangles
    @ (ring: list[f64]) -> result[list[i32], string]
  ...
  triangulate.polygon_with_holes
    @ (outer: list[f64], holes: list[list[f64]]) -> result[list[i32], string]
  ...
  triangulate.line_to_strip
    @ (points: list[f64], width: f64) -> list[f64]
  ...
  triangulate.line_to_indexed_mesh
    @ (points: list[f64], width: f64) -> tuple[list[f64], list[i32]]
