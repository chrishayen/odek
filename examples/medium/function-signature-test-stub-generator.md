...
std
  std.strings
    std.strings.trim
      ...
      # text
    std.strings.join
      fn (items: list[string], sep: string) -> string
...
stub_gen
  stub_gen.parse_signatures
    fn (source: string) -> result[list[function_signature], string]
  ...
  stub_gen.signature_to_stub
    fn (sig: function_signature) -> string
  ...
  stub_gen.render_stubs
    fn (signatures: list[function_signature]) -> string
