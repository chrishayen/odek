...
colour
  ...
  colour.rgb_to_xyz
    ...
    # conversion
  colour.xyz_to_lab
    @ (x: f64, y: f64, z: f64) -> tuple[f64, f64, f64]
    + returns CIE L*a*b*
    # conversion
  colour.delta_e_cie76
    @ (lab_a: tuple[f64, f64, f64], lab_b: tuple[f64, f64, f64]) -> f64
  ...
  colour.delta_e_ciede2000
    ...
    # comparison
  colour.mix
    @ (a: tuple[u8, u8, u8], b: tuple[u8, u8, u8], t: f64) -> tuple[u8, u8, u8]
  ...
  colour.contrast_ratio
    @ (a: tuple[u8, u8, u8], b: tuple[u8, u8, u8]) -> f64
