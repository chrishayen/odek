...
hex_geojson
  hex_geojson.cell_to_feature
    fn (cell: u64, properties: map[string, string]) -> string
  ...
  hex_geojson.polyfill_bbox
    fn (min_lat: f64, min_lon: f64, max_lat: f64, max_lon: f64, resolution: i32) -> list[u64]
