...
interline
  ...
  interline.complete
    ...
    # completion
  interline.read_line
    fn (state: line_state, hist: history_state) -> result[tuple[string, history_state], string]
