...
image_filters
  image_filters.new_image
    @ (width: i32, height: i32, pixels: bytes) -> result[image, string]
  ...
  image_filters.sharpen
    @ (img: image, amount: f32) -> image
    + unsharp mask style sharpening with the given strength
    # convolution
  image_filters.resize
    @ (img: image, new_width: i32, new_height: i32) -> result[image, string]
