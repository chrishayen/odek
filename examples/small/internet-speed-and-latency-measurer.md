...
std
  ...
  std.net
    ...
    std.net.http_post_bytes
      fn (url: string, body: bytes) -> result[i64, string]
...
speed_test
  speed_test.measure_ping
    fn (url: string, samples: i32) -> result[f64, string]
  ...
  speed_test.measure_download
    fn (url: string) -> result[f64, string]
  ...
  speed_test.measure_upload
    fn (url: string, payload_bytes: i64) -> result[f64, string]
