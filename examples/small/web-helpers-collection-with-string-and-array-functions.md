...
web_helpers
  web_helpers.str_pad_left
    fn (value: string, total_width: i32, pad: string) -> string
  ...
  web_helpers.array_slice
    fn (values: list[string], offset: i32, length: i32) -> list[string]
  ...
  web_helpers.array_get
    fn (values: map[string, string], key: string, default_value: string) -> string
