...
ticker_mux
  ticker_mux.new
    @ (interval_nanos: i64) -> ticker_mux_state
  ...
  ticker_mux.wait_and_broadcast
    @ (state: ticker_mux_state) -> tuple[i64, list[subscriber_id]]
