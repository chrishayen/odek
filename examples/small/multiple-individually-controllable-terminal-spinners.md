...
spinners
  spinners.new
    ...
    # construction
  spinners.add
    @ (state: spinners_state, name: string, label: string) -> spinners_state
    + adds a spinner in the "running" status with frame index 0
    # registration
  spinners.set_status
    @ (state: spinners_state, name: string, status: string) -> result[spinners_state, string]
  ...
  spinners.render_frame
    @ (state: spinners_state) -> tuple[string, spinners_state]
