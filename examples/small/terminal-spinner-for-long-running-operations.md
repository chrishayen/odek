...
spinner
  spinner.new
    fn (frames: list[string], interval_ms: i32) -> spinner_state
  ...
  spinner.current_frame
    fn (state: spinner_state) -> tuple[string, spinner_state]
  ...
  spinner.with_message
    fn (state: spinner_state, message: string) -> spinner_state
