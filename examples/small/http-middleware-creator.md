...
middleware
  middleware.chain
    fn (middlewares: list[middleware_handle], final: handler_handle) -> handler_handle
  ...
  middleware.with_logging
    fn (inner: handler_handle) -> handler_handle
  ...
  middleware.with_timeout
    fn (inner: handler_handle, millis: i32) -> handler_handle
