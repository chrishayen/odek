...
query_cache
  query_cache.new
    fn (default_ttl_ms: i64, max_entries: i32) -> cache_state
  ...
  query_cache.get
    ...
    -> std.time.now_millis
  query_cache.put
    fn (cache: cache_state, key: string, value: bytes, ttl_ms: i64) -> cache_state
    + stores a value with an explicit TTL, evicting the oldest entry when full
    # writes
    -> std.time.now_millis
  query_cache.invalidate
    fn (cache: cache_state, key: string) -> cache_state
