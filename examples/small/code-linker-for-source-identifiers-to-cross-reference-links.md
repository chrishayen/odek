...
code_linker
  ...
  code_linker.register_resolver
    fn (state: linker_state, language: string, resolver: symbol_resolver) -> linker_state
  ...
  code_linker.identifier_at
    fn (source: string, byte_offset: i32) -> result[tuple[string, i32, i32], string]
  ...
  code_linker.resolve_link
    fn (state: linker_state, language: string, source: string, byte_offset: i32) -> result[string, string]
