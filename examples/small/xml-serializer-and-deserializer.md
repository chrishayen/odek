...
xserde
  xserde.serialize
    @ (value: record_value, schema: xml_schema) -> result[string, string]
    ...
    -> std.xml.serialize
  xserde.deserialize
    @ (raw: string, schema: xml_schema) -> result[record_value, string]
  ...
  xserde.schema_from_fields
    @ (fields: list[field_descriptor]) -> xml_schema
