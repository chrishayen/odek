...
tv_renamer
  tv_renamer.parse_filename
    fn (filename: string) -> result[episode_ref, string]
  ...
  tv_renamer.lookup_title
    fn (source: metadata_source, ref: episode_ref) -> result[string, string]
  ...
  tv_renamer.build_name
    fn (ref: episode_ref, title: string, template: string) -> string
  ...
  tv_renamer.rename_batch
    fn (filenames: list[string], source: metadata_source, template: string) -> list[rename_plan_row]
