...
cell_nav
  cell_nav.parse_cell_name
    fn (name: string) -> result[tuple[i32, i32], string]
  ...
  cell_nav.format_cell_name
    fn (row: i32, col: i32) -> result[string, string]
    + returns the cell name for a given row and column
    - returns error when row or col is negative
    # formatting
  cell_nav.offset
    fn (name: string, row_delta: i32, col_delta: i32) -> result[string, string]
