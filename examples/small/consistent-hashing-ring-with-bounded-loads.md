...
bounded_ring
  bounded_ring.new
    fn (epsilon: f64) -> bounded_ring_state
    + creates an empty ring with load factor 1 + epsilon
    # construction
  bounded_ring.add_node
    fn (state: bounded_ring_state, node: string) -> bounded_ring_state
  ...
  bounded_ring.remove_node
    ...
    # membership
  bounded_ring.assign
    fn (state: bounded_ring_state, key: string) -> tuple[string, bounded_ring_state]
  ...
  bounded_ring.release
    fn (state: bounded_ring_state, key: string) -> bounded_ring_state
