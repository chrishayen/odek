...
pmap
  pmap.map
    fn (items: list[T], mapper: fn(T) -> result[U, string], concurrency: i32) -> result[list[U], string]
    ...
    # concurrency
  pmap.map_settled
    fn (items: list[T], mapper: fn(T) -> result[U, string], concurrency: i32) -> list[result[U, string]]
