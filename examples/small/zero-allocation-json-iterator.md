...
json_iter
  json_iter.new
    fn (source: string) -> iter_state
    + creates an iterator positioned at the start of source
    # construction
  json_iter.next_token
    fn (it: iter_state) -> result[optional[json_token], string]
  ...
  json_iter.read_string_slice
    ...
    # zero_copy
  json_iter.expect
    fn (it: iter_state, kind: token_kind) -> result[void, string]
