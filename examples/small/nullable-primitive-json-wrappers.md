...
nullable
  ...
  nullable.f64_to_json
    @ (v: optional[f64]) -> string
    + returns the json number form, or "null" when absent
    # marshalling
    -> std.json.encode_value
  nullable.f64_from_json
    @ (raw: string) -> result[optional[f64], string]
