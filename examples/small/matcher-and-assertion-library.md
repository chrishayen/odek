...
matchers
  ...
  matchers.expect_length
    @ (items: list[string], expected: i32) -> optional[string]
  ...
  matchers.expect_true
    @ (value: bool, label: string) -> optional[string]
