...
unixservice
  ...
  unixservice.render_unit
    ...
    # rendering
  unixservice.install
    fn (spec: service_spec, unit_dir: string, host: service_host) -> result[void, string]
  ...
  unixservice.uninstall
    fn (name: string, unit_dir: string, host: service_host) -> result[void, string]
