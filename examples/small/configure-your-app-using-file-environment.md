...
layered_config
  ...
  layered_config.overlay_env
    @ (base: map[string,string], prefix: string) -> map[string,string]
  ...
  layered_config.parse_flags
    @ (argv: list[string]) -> map[string,string]
    + parses --key=value and --key value forms into a map
    # parsing
  layered_config.merge
    @ (file: map[string,string], env: map[string,string], flags: map[string,string]) -> map[string,string]
