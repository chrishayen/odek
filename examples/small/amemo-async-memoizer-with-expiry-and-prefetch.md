...
amemo
  amemo.new_cache
    fn (ttl_millis: i64, prefetch_millis: i64) -> amemo_cache
  ...
  amemo.get_or_compute
    fn (cache: amemo_cache, key: string, loader: async_fn) -> result[bytes, string]
    ...
    -> std.time.now_millis
  amemo.invalidate
    fn (cache: amemo_cache, key: string) -> amemo_cache
    + removes any entry stored under key
    # invalidation
  amemo.sweep_expired
    fn (cache: amemo_cache) -> amemo_cache
