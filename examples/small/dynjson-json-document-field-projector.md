...
dynjson
  ...
  dynjson.project_value
    fn (value: json_value, sel: selection) -> json_value
    + returns a json value with only the selected subtree
    # projection
  dynjson.merge_selections
    fn (a: selection, b: selection) -> selection
