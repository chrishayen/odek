...
envdoc
  envdoc.new_variable
    fn (name: string, type_name: string, default_value: string, description: string, required: bool) -> env_var
    + builds an env var record
    # model
  envdoc.parse_comment_block
    fn (raw: string) -> result[env_var, string]
