...
learnpath
  learnpath.new_tree
    ...
    # construction
  learnpath.add_node
    fn (tree: tree_state, node_id: string, title: string, prerequisites: list[string]) -> result[tree_state, string]
