...
dotenv_props
  dotenv_props.get
    fn (env: map[string,string], path: string) -> optional[string]
    ...
    -> std.strings.join
  dotenv_props.set
    fn (env: map[string,string], path: string, value: string) -> map[string,string]
    ...
    -> std.strings.join
  dotenv_props.delete
    fn (env: map[string,string], path: string) -> map[string,string]
    ...
    -> std.strings.join
  dotenv_props.has
    fn (env: map[string,string], path: string) -> bool
