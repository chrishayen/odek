...
stringsearch
  stringsearch.search_text
    fn (text: string, needle: string) -> list[match]
  ...
  stringsearch.search_file
    fn (path: string, needle: string) -> result[list[match], string]
  ...
  stringsearch.search_tree
    fn (root: string, needle: string) -> result[map[string, list[match]], string]
