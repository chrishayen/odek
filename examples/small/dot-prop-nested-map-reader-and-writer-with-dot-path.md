...
dot_prop
  dot_prop.split_path
    ...
    # path_parsing
  dot_prop.get
    fn (obj: map[string, string], path: string) -> result[string, string]
    ...
    -> dot_prop.split_path
  dot_prop.set
    fn (obj: map[string, string], path: string, value: string) -> map[string, string]
    + stores value at the given dotted path and returns the updated map
    # write
    -> dot_prop.split_path
  dot_prop.has
    fn (obj: map[string, string], path: string) -> bool
    + returns true when the path exists in the object
    # existence
    -> dot_prop.split_path
  dot_prop.delete
    fn (obj: map[string, string], path: string) -> map[string, string]
