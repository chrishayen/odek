...
supervisor
  supervisor.new
    @ (command: list[string], watched: list[string]) -> supervisor_state
  ...
  supervisor.start
    ...
    -> std.process.spawn
  supervisor.poll
    @ (state: supervisor_state) -> supervisor_event
