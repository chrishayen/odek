...
cors
  cors.new_policy
    fn (allowed_origins: list[string], allowed_methods: list[string], allow_credentials: bool, max_age_seconds: i32) -> cors_policy
  ...
  cors.preflight_headers
    fn (policy: cors_policy, origin: string, requested_method: string) -> result[map[string, string], string]
  ...
  cors.response_headers
    fn (policy: cors_policy, origin: string) -> map[string, string]
