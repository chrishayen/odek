...
log_format
  log_format.redact
    fn (keys: list[string]) -> attr_formatter
    ...
    # redaction
  log_format.rename
    fn (mapping: map[string, string]) -> attr_formatter
  ...
  log_format.error_to_string
    ...
    # error_shaping
  log_format.chain
    fn (formatters: list[attr_formatter]) -> attr_formatter
    ...
    # composition
  log_format.apply
    fn (f: attr_formatter, key: string, value: string) -> tuple[string, string]
