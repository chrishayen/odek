...
timespan
  timespan.new
    fn (start_unix_ms: i64, duration_ms: i64) -> timespan_value
  ...
  timespan.intersection
    fn (a: timespan_value, b: timespan_value) -> optional[timespan_value]
