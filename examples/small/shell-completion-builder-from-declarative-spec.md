...
completions
  completions.load_spec
    fn (raw: string) -> result[spec_state, string]
    ...
    -> std.encoding.parse_yaml
  completions.suggest
    fn (spec: spec_state, tokens: list[string], prefix: string) -> list[string]
  ...
  completions.describe
    fn (spec: spec_state, path: list[string]) -> result[string, string]
