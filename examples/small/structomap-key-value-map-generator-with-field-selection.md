...
structomap
  structomap.new
    ...
    # construction
  structomap.pick
    fn (t: transformer, field: string) -> transformer
    + adds a field to be copied as-is into the output map
    # selection
  structomap.rename
    fn (t: transformer, source_field: string, target_key: string) -> transformer
  ...
  structomap.omit
    ...
    # exclusion
  structomap.apply
    fn (t: transformer, record: map[string, string]) -> map[string, string]
