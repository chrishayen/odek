...
zerocopy
  zerocopy.view_u32_le
    @ (buf: bytes, offset: u32) -> result[u32, string]
  ...
  zerocopy.view_i64_le
    @ (buf: bytes, offset: u32) -> result[i64, string]
    ...
    -> std.mem.size_of
  zerocopy.slice
    @ (buf: bytes, offset: u32, length: u32) -> result[bytes, string]
  ...
  zerocopy.write_u32_le
    @ (buf: bytes, offset: u32, value: u32) -> result[void, string]
