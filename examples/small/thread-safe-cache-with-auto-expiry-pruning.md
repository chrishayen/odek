...
gocache
  ...
  gocache.get
    ...
    -> std.sync.with_lock
  gocache.delete
    fn (cache: cache_state, key: string) -> void
    + removes an entry if it exists
    # mutation
    -> std.sync.with_lock
  gocache.prune_expired
    fn (cache: cache_state) -> u32
