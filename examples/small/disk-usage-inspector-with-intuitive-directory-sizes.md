...
std
  std.fs
    std.fs.walk
      fn (path: string) -> list[file_entry]
...
dust
  ...
  dust.format_size
    ...
    # formatting
  dust.render_tree
    fn (sizes: map[string, u64], root: string, max_depth: i32) -> string
