...
versioninfo
  versioninfo.build
    fn (name: string, semver: string, commit: string, built_at: string) -> versioninfo_state
    + constructs a version record from build metadata
    # construction
  versioninfo.format_short
    fn (info: versioninfo_state) -> string
    + returns "name vX.Y.Z"
    # formatting
  ...
  versioninfo.upgrade_notice
    fn (current: string, latest: string) -> optional[string]
