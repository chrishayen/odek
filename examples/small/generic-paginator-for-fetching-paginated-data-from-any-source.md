...
paginator
  ...
  paginator.fetch_page
    fn (state: paginator_state, fetcher: page_fetcher, cursor: optional[string]) -> result[page_result, string]
  ...
  paginator.iter_pages
    fn (state: paginator_state, fetcher: page_fetcher) -> page_iterator
