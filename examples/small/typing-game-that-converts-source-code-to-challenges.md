...
typing_game
  ...
  typing_game.score_attempt
    @ (target: string, typed: string, elapsed_ms: i64) -> attempt_score
  ...
  typing_game.format_diff
    @ (target: string, typed: string) -> list[char_status]
