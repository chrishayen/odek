...
retry
  retry.new_policy
    fn (max_attempts: i32, base_delay_ms: i64, max_delay_ms: i64) -> retry_policy
    + returns a policy with exponential backoff between base and max
    # construction
  retry.next_delay
    fn (policy: retry_policy, attempt: i32) -> optional[i64]
    ...
    # scheduling
  retry.wait_before
    fn (policy: retry_policy, attempt: i32) -> bool
