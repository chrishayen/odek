...
align
  ...
  align.pad_cell
    ...
    # padding
  align.format_rows
    fn (rows: list[list[string]], alignments: list[string], separator: string) -> list[string]
