...
config :valkyrie, ValkyrieWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "W3E6yyy+6wwH2G6xh3I6D9JotkbHPqDUEV5Deh8DNsr/YABVLf7GjUCyV+/KGEbW",
  watchers: [
...
config :valkyrie, ValkyrieWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/valkyrie_web/router\.ex$"E,
      ~r"lib/valkyrie_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :valkyrie, dev_routes: true
